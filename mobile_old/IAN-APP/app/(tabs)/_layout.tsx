...
export default function TabsLayout() {
  // This state will hold the user object from Firebase if logged in, or null if not.
  ...
  // While Firebase is checking the user's status, we render nothing to avoid screen flashes.
  if (!isLoaded) {
    return null;
  }
